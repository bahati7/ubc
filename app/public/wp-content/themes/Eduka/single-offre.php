       ...
       <div class="site-breadcrumb" style="background-image: url('<?php echo esc_url(get_template_directory_uri()); ?>/assets/img/breadcrumb/02.jpg');">
            <div class="container">
                ...
                <ul class="breadcrumb-menu">
                    <li> <a href="<?php  echo get_post_type_archive_link('offre') ?>"> Retour aux Offres </a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="widget event-single-info">
                            <h4 class="widget-title">Détails sur l'offre</h4>
                            <p>
                                <?php the_field('description');?>
                            </p>
                            <div class="event-content">
                                <div class="event-content-single">
                                    <h5><a href="#">Date de cloture</a></h5>
                                    <?php 
                                        $end_date = get_field('date_cloture'); // get ACF value
                                        if ($end_date) {
                                            // Convert to DateTime (adjust format to your ACF return format)
                                            $date_obj = new DateTime($end_date);
                                            echo '<p><i class="far fa-calendar-alt"></i>  ' . esc_html($date_obj->format('F j, Y')) . '</p>';
                                        }
                                        ?>
                                </div>
                                <div class="event-content-single">
                                    <h5><a href="#">Numero de l'offre</a></h5>
                                    <p><i class="far fa-clock"></i>  <?php the_field('numero');?></p>
                                </div>
                                <div class="event-content-single">
                                    <h5><a href="#">Lien de l'offre</a></h5>
                                    <p><i class="far fa-map-marker-alt"></i> <?php the_field('offre_lien');?></p>
                                </div>
                                <div class="event-content-single">
                                    <h5><a href="#">Contact</a></h5>
                                    <p><i class="far fa-usd-circle"></i> <?php the_field('contact');?></p>
                                </div>
                        ...
                        <div class="widget event-author">                          
                            ...
                            <div class="widget event-author">
                                <h4 class="widget-title">Offre publiée par:</h4>
