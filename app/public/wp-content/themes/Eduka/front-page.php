        ...
        <div class="partner-area bg pt-50 pb-50">
            <div class="container">
                <div class="partner-wrapper partner-slider owl-carousel owl-theme">
                    ...
                    <img src="<?php echo get_theme_file_uri('assets/img/partner/01.png'); ?>" alt="thumb">
                    <img src="<?php echo get_theme_file_uri('assets/img/partner/02.png'); ?>" alt="thumb">
                    <img src="<?php echo get_theme_file_uri('assets/img/partner/03.png'); ?>" alt="thumb">
                    <img src="<?php echo get_theme_file_uri('assets/img/partner/04.png'); ?>" alt="thumb">
                    <img src="<?php echo get_theme_file_uri('assets/img/partner/5.png'); ?>" alt="thumb">
                    <img src="<?php echo get_theme_file_uri('assets/img/partner/6.png'); ?>" alt="thumb">
                    <img src="<?php echo get_theme_file_uri('assets/img/partner/7.jpg'); ?>" alt="thumb">
                </div>
            </div>
        </div>
        <!-- partner area end -->
